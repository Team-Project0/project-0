...
const Login = () => {
  ...
  <Box  sx={{
    ...
    borderColor: '#0062cc',
    boxShadow: 'none',
  }, borderRadius:1,mt:3, mb: 2 ,bgcolor:deepPurple[400],color: '#fff',}} id="login">Login</Button>
        <Button  sx={{ '&:hover': {
    backgroundColor: '#3a2774',
    borderColor: '#0062cc',
    boxShadow: 'none',
  }, borderRadius:1,mt:3, mb: 2 ,bgcolor:deepPurple[400],color: '#fff',}} id="login">SignIn</Button>
      
      </Box>
    </div>  
  <div class="item4"> <img class="rotation" src="https://www.milka.com/content/dam/mondelezwoop/milka/milka-chocolate.png" />
           </div>
           <img class="chocolate2"src="https://www.milka.com/content/dam/mondelezwoop/milka/chunk-2.png"/>
          </div>
